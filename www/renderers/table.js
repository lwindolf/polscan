...
renderers.table.prototype.createGroupTable = function(id, results, params) {
...
renderers.table.prototype.createResultTable = function(id, results, params) {
	var group = '';
	var name = params.fG;
...
renderers.table.prototype.render = function(id, results, params) {
	if(!params.gI)
		this.createResultTable(id, results, params);
	else
		this.createGroupTable(id, results, params);
}
